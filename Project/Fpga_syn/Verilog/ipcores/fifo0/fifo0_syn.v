...
//dcfifo_mixed_widths DEVICE_FAMILY="Cyclone IV E" LPM_NUMWORDS=32 LPM_SHOWAHEAD="OFF" LPM_WIDTH=8 LPM_WIDTH_R=8 LPM_WIDTHU=5 LPM_WIDTHU_R=5 OVERFLOW_CHECKING="ON" RDSYNC_DELAYPIPE=4 UNDERFLOW_CHECKING="ON" USE_EAB="ON" WRSYNC_DELAYPIPE=4 data q rdclk rdempty rdfull rdreq rdusedw wrclk wrempty wrfull wrreq wrusedw INTENDED_DEVICE_FAMILY="Cyclone IV E" ALTERA_INTERNAL_OPTIONS=AUTO_SHIFT_REGISTER_RECOGNITION=OFF
...
//a_gray2bin device_family="Cyclone IV E" WIDTH=6 bin gray
...
module  fifo0_a_gray2bin
	...
	assign
		...
		xor3 = (gray[3] ^ xor4),
		xor4 = (gray[5] ^ gray[4]);
endmodule //fifo0_a_gray2bin


//a_graycounter DEVICE_FAMILY="Cyclone IV E" PVALUE=1 WIDTH=6 clock cnt_en q
...
`endif
	...
	always @ ( posedge clock)
			...
			else  sub_parity7a[1:1] <= ((cnt_en & (counter5a[4] ^ counter5a[5])) | ((~ cnt_en) & sub_parity7a[1:1]));
	assign
...
`endif
	...
	always @ ( posedge clock)
			...
			else  counter8a[5:5] <= (counter8a[5:5] ^ cntr_cout[4]);
	// synopsys translate_off
	initial
		parity9 = {1{1'b1}};
	// synopsys translate_on
	...
	always @ ( posedge clock)
			...
			else  sub_parity10a[1:1] <= ((cnt_en & (counter8a[4] ^ counter8a[5])) | ((~ cnt_en) & sub_parity10a[1:1]));
	assign
		cntr_cout = {1'b0, (cntr_cout[3] & (~ counter8a[3:3])), (cntr_cout[2] & (~ counter8a[2:2])), (cntr_cout[1] & (~ counter8a[1:1])), (cntr_cout[0] & (~ counter8a[0:0])), (cnt_en & parity_cout)},
		parity_cout = (((~ parity9) ^ updown) & cnt_en),
		q = counter8a,
		sclr = 1'b0,
		updown = 1'b1;
endmodule //fifo0_a_graycounter1


//altsyncram ADDRESS_REG_B="CLOCK1" CLOCK_ENABLE_INPUT_B="BYPASS" DEVICE_FAMILY="Cyclone IV E" OPERATION_MODE="DUAL_PORT" OUTDATA_ACLR_B="CLEAR1" OUTDATA_REG_B="CLOCK1" WIDTH_A=8 WIDTH_B=8 WIDTH_BYTEENA_A=1 WIDTHAD_A=5 WIDTHAD_B=5 address_a address_b addressstall_b clock0 clock1 clocken1 data_a q_b wren_a
...
`endif
	...
	defparam
		...
		ram_block11a_0.port_a_address_width = 5,
		ram_block11a_0.port_a_data_width = 1,
		ram_block11a_0.port_a_first_address = 0,
		ram_block11a_0.port_a_first_bit_number = 0,
		ram_block11a_0.port_a_last_address = 31,
		ram_block11a_0.port_a_logical_ram_depth = 32,
		...
		ram_block11a_0.port_b_address_width = 5,
		...
		ram_block11a_0.port_b_last_address = 31,
		ram_block11a_0.port_b_logical_ram_depth = 32,
	...
	defparam
		...
		ram_block11a_1.port_a_address_width = 5,
		ram_block11a_1.port_a_data_width = 1,
		ram_block11a_1.port_a_first_address = 0,
		ram_block11a_1.port_a_first_bit_number = 1,
		ram_block11a_1.port_a_last_address = 31,
		ram_block11a_1.port_a_logical_ram_depth = 32,
		...
		ram_block11a_1.port_b_address_width = 5,
		...
		ram_block11a_1.port_b_last_address = 31,
		ram_block11a_1.port_b_logical_ram_depth = 32,
	...
	defparam
		...
		ram_block11a_2.port_a_address_width = 5,
		ram_block11a_2.port_a_data_width = 1,
		ram_block11a_2.port_a_first_address = 0,
		ram_block11a_2.port_a_first_bit_number = 2,
		ram_block11a_2.port_a_last_address = 31,
		ram_block11a_2.port_a_logical_ram_depth = 32,
		...
		ram_block11a_2.port_b_address_width = 5,
		...
		ram_block11a_2.port_b_last_address = 31,
		ram_block11a_2.port_b_logical_ram_depth = 32,
	...
	defparam
		...
		ram_block11a_3.port_a_address_width = 5,
		ram_block11a_3.port_a_data_width = 1,
		ram_block11a_3.port_a_first_address = 0,
		ram_block11a_3.port_a_first_bit_number = 3,
		ram_block11a_3.port_a_last_address = 31,
		ram_block11a_3.port_a_logical_ram_depth = 32,
		...
		ram_block11a_3.port_b_address_width = 5,
		...
		ram_block11a_3.port_b_last_address = 31,
		ram_block11a_3.port_b_logical_ram_depth = 32,
	...
	defparam
		...
		ram_block11a_4.port_a_address_width = 5,
		ram_block11a_4.port_a_data_width = 1,
		ram_block11a_4.port_a_first_address = 0,
		ram_block11a_4.port_a_first_bit_number = 4,
		ram_block11a_4.port_a_last_address = 31,
		ram_block11a_4.port_a_logical_ram_depth = 32,
		...
		ram_block11a_4.port_b_address_width = 5,
		...
		ram_block11a_4.port_b_last_address = 31,
		ram_block11a_4.port_b_logical_ram_depth = 32,
	...
	defparam
		...
		ram_block11a_5.port_a_address_width = 5,
		ram_block11a_5.port_a_data_width = 1,
		ram_block11a_5.port_a_first_address = 0,
		ram_block11a_5.port_a_first_bit_number = 5,
		ram_block11a_5.port_a_last_address = 31,
		ram_block11a_5.port_a_logical_ram_depth = 32,
		...
		ram_block11a_5.port_b_address_width = 5,
		...
		ram_block11a_5.port_b_last_address = 31,
		ram_block11a_5.port_b_logical_ram_depth = 32,
	...
	defparam
		...
		ram_block11a_6.port_a_address_width = 5,
		ram_block11a_6.port_a_data_width = 1,
		ram_block11a_6.port_a_first_address = 0,
		ram_block11a_6.port_a_first_bit_number = 6,
		ram_block11a_6.port_a_last_address = 31,
		ram_block11a_6.port_a_logical_ram_depth = 32,
		...
		ram_block11a_6.port_b_address_width = 5,
		...
		ram_block11a_6.port_b_last_address = 31,
		ram_block11a_6.port_b_logical_ram_depth = 32,
	...
	defparam
		...
		ram_block11a_7.port_a_address_width = 5,
		ram_block11a_7.port_a_data_width = 1,
		ram_block11a_7.port_a_first_address = 0,
		ram_block11a_7.port_a_first_bit_number = 7,
		ram_block11a_7.port_a_last_address = 31,
		ram_block11a_7.port_a_logical_ram_depth = 32,
		...
		ram_block11a_7.port_b_address_width = 5,
		...
		ram_block11a_7.port_b_last_address = 31,
		ram_block11a_7.port_b_logical_ram_depth = 32,
...
`endif
	...
	always @ ( posedge clock or  negedge prn or  negedge clrn)
		...
		else if  (ena == 1'b1)   dffe12a <= (d & {6{(~ sclr)}});
	assign
		clrn = 1'b1,
		ena = 1'b1,
		prn = 1'b1,
...
`endif
	...
	// synopsys translate_on
	always @ ( posedge clock or  negedge prn or  negedge clrn)
		if (prn == 1'b0) dffe14a <= {6{1'b1}};
		else if (clrn == 1'b0) dffe14a <= 6'b0;
		else if  (ena == 1'b1)   dffe14a <= (d & {6{(~ sclr)}});
	// synopsys translate_off
	initial
		dffe15a = 0;
	// synopsys translate_on
	always @ ( posedge clock or  negedge prn or  negedge clrn)
		...
		else if  (ena == 1'b1)   dffe15a <= (dffe14a & {6{(~ sclr)}});
	assign
		clrn = 1'b1,
		ena = 1'b1,
		prn = 1'b1,
...
module  fifo0_alt_synch_pipe
	...
	wire  [5:0]   wire_dffpipe13_q;

	fifo0_dffpipe1   dffpipe13
	( 
	.clock(clock),
	.d(d),
	.q(wire_dffpipe13_q));
	assign
		q = wire_dffpipe13_q;
endmodule //fifo0_alt_synch_pipe
...
`endif
	...
	// synopsys translate_on
	always @ ( posedge clock or  negedge prn or  negedge clrn)
		if (prn == 1'b0) dffe17a <= {6{1'b1}};
		else if (clrn == 1'b0) dffe17a <= 6'b0;
		else if  (ena == 1'b1)   dffe17a <= (d & {6{(~ sclr)}});
	// synopsys translate_off
	initial
		dffe18a = 0;
	// synopsys translate_on
	always @ ( posedge clock or  negedge prn or  negedge clrn)
		if (prn == 1'b0) dffe18a <= {6{1'b1}};
		else if (clrn == 1'b0) dffe18a <= 6'b0;
		else if  (ena == 1'b1)   dffe18a <= (dffe17a & {6{(~ sclr)}});
	assign
		clrn = 1'b1,
		ena = 1'b1,
		prn = 1'b1,
...
module  fifo0_alt_synch_pipe1
	...
	wire  [5:0]   wire_dffpipe16_q;

	fifo0_dffpipe12   dffpipe16
	( 
	.clock(clock),
	.d(d),
	.q(wire_dffpipe16_q));
	assign
		q = wire_dffpipe16_q;
endmodule //fifo0_alt_synch_pipe1


//lpm_add_sub DEVICE_FAMILY="Cyclone IV E" LPM_DIRECTION="SUB" LPM_WIDTH=6 dataa datab result
...
//lpm_compare DEVICE_FAMILY="Cyclone IV E" LPM_WIDTH=6 aeb dataa datab
...
endmodule //fifo0_cmpr

//synthesis_resources = lut 14 M9K 1 reg 84 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"AUTO_SHIFT_REGISTER_RECOGNITION=OFF;REMOVE_DUPLICATE_REGISTERS=OFF;SYNCHRONIZER_IDENTIFICATION=OFF;SYNCHRONIZATION_REGISTER_CHAIN_LENGTH = 2;suppress_da_rule_internal=d101;suppress_da_rule_internal=d102;suppress_da_rule_internal=d103;-name CUT ON -from rdptr_g -to ws_dgrp|fifo0_dffpipe12:dffpipe16|dffe17a;-name SDC_STATEMENT \"set_false_path -from *rdptr_g* -to *ws_dgrp|fifo0_dffpipe12:dffpipe16|dffe17a* \";-name CUT ON -from delayed_wrptr_g -to rs_dgwp|fifo0_dffpipe1:dffpipe13|dffe14a;-name SDC_STATEMENT \"set_false_path -from *delayed_wrptr_g* -to *rs_dgwp|fifo0_dffpipe1:dffpipe13|dffe14a* \""} *)
module  fifo0_dcfifo
	( 
	data,
	q,
	...
	wire  [5:0]   wire_rdptr_g_gray2bin_bin;
	wire  [5:0]   wire_rs_dgwp_gray2bin_bin;
	...
	reg	[5:0]	wrptr_g;
	wire  [5:0]   wire_rs_brp_q;
	wire  [5:0]   wire_rs_bwp_q;
	wire  [5:0]   wire_rs_dgwp_q;
	wire  [5:0]   wire_ws_brp_q;
	wire  [5:0]   wire_ws_bwp_q;
	wire  [5:0]   wire_ws_dgrp_q;
	wire	[5:0]	wire_rdusedw_sub_dataa;
	wire	[5:0]	wire_rdusedw_sub_datab;
	wire	[5:0]	wire_rdusedw_sub_result;
	...
	fifo0_a_gray2bin   rdptr_g_gray2bin
	( 
	.bin(wire_rdptr_g_gray2bin_bin),
	.gray(rdptr_g[5:0]));
	fifo0_a_gray2bin   rs_dgwp_gray2bin
	( 
	.bin(wire_rs_dgwp_gray2bin_bin),
	.gray(wire_rs_dgwp_q[5:0]));
	fifo0_a_gray2bin   wrptr_g_gray2bin
	( 
	.bin(wire_wrptr_g_gray2bin_bin),
	.gray(wrptr_g[5:0]));
	fifo0_a_gray2bin   ws_dgrp_gray2bin
	( 
	.bin(wire_ws_dgrp_gray2bin_bin),
	.gray(wire_ws_dgrp_q[5:0]));
	fifo0_a_graycounter   rdptr_g1p
	( 
	.clock(rdclk),
	.cnt_en(valid_rdreq),
	.q(wire_rdptr_g1p_q));
	fifo0_a_graycounter1   wrptr_g1p
	( 
	.clock(wrclk),
	.cnt_en(valid_wrreq),
	.q(wire_wrptr_g1p_q));
	fifo0_altsyncram   fifo_ram
	( 
	...
	fifo0_dffpipe   rs_brp
	( 
	.clock(rdclk),
	.d(wire_rdptr_g_gray2bin_bin),
	.q(wire_rs_brp_q));
	fifo0_dffpipe   rs_bwp
	( 
	.clock(rdclk),
	.d(wire_rs_dgwp_gray2bin_bin),
	.q(wire_rs_bwp_q));
	fifo0_alt_synch_pipe   rs_dgwp
	( 
	.clock(rdclk),
	.d(delayed_wrptr_g),
	.q(wire_rs_dgwp_q));
	fifo0_dffpipe   ws_brp
	( 
	.clock(wrclk),
	.d(wire_ws_dgrp_gray2bin_bin),
	.q(wire_ws_brp_q));
	fifo0_dffpipe   ws_bwp
	( 
	.clock(wrclk),
	.d(wire_wrptr_g_gray2bin_bin),
	.q(wire_ws_bwp_q));
	fifo0_alt_synch_pipe1   ws_dgrp
	( 
	.clock(wrclk),
	.d(rdptr_g),
	.q(wire_ws_dgrp_q));
	...
	assign
		...
		rdusedw = {wire_rdusedw_sub_result[4:0]},
...
module fifo0 (
	...
	fifo0_dcfifo	fifo0_dcfifo_component (
				.rdclk (rdclk),
				.wrclk (wrclk),
				.wrreq (wrreq),
				.data (data),
